...
import { FiLogOut, FiHome, FiUsers, FiUser } from "react-icons/fi";
...
const Sidebar = () => {
    ...
    return (
        <aside className="fixed left-0 top-0 h-screen w-60 bg-ink text-paper flex flex-col justify-between z-40">
            <div>
                <div className="px-6 py-8 border-b border-line-dark">
                    <span className="font-display text-2xl tracking-tight">Stacks</span>
                    <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-paper-soft mt-1">
                        Library System
                    </p>
                </div>
                            ...
                            <Link
                                ...
                                className={`flex items-center gap-3 px-6 py-3 font-mono text-xs uppercase tracking-[0.15em] border-l-2 transition-colors ${
                                    active
                                        ...
                                        : "border-transparent text-paper-soft hover:text-paper hover:bg-white/5"
                                }`}
                            >
                                <Icon size={14} />
                                {label}
            ...
            <div className="px-6 py-6 border-t border-line-dark">
                ...
                <button
                    ...
                    className="flex items-center gap-2 font-mono text-xs uppercase tracking-[0.15em] text-paper-soft hover:text-paper transition-colors"
                >
